...
```{r setup, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
library(ggplot2)
library(dplyr)
library(RPostgreSQL)
library(stringr)
...
```{r varfreq, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r common_variants, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r loci, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r titvg, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r titvc, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r kaks, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
By gene
```{r kaksbygene, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
# Population genetics
```{r popgen, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
europe<-list("H"="(H$|H[^V])","HV"="HV","I"="I","J"="J","K"="K","R"="R","T"="T","U"="U","V"="V","W"="W","X"="X")
africa<-list("L0"="L0","L1"="L1","L2"="L2","L3"="L3","L4"="L4","L5"="L5","L6"="L6")
asia<-list("F"="F","B"="B","P"="P","A"="A","S"="S","O"="O","Y"="Y","N"="N","M"="M","Q"="Q","G"="G","E"="E","D"="D","C"="C","Z"="Z")
...
return_prefix<-function(haplogroup){
  names(all_prefixes[which(!is.na(str_locate(haplogroup[1],prefix_pats)[,"start"]))])[1]
}
```
...
```{r byreg, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r bypre, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r disease_reg, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r disease_fish, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
# PCA
```{r pca, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r doregion, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r europe, ref.label='doregion', echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
```
...
```{r asia, ref.label='doregion', echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
```
...
```{r dnsnp, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r market_basket, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
...
```{r conservation, echo=FALSE, message=FALSE, fig.path='{{SLINK}}/'}
