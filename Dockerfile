...
RUN apt-get update && apt-get install --allow-unauthenticated -y software-properties-common postgresql-9.3 postgresql-client-9.3 postgresql-contrib-9.3 supervisor
